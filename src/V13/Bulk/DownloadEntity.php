...

{
    ...
    final class DownloadEntity
    {
        ...
        /** Include Campaign Age Criterion, Campaign Company Name Criterion, Campaign DayTime Criterion, Campaign DeviceOS Criterion, Campaign Gender Criterion, Campaign Industry Criterion, Campaign Job Function Criterion, Campaign Location Criterion, Campaign Location Intent Criterion, Campaign Negative Age Criterion, Campaign Negative Device Criterion, Campaign Negative Gender Criterion, Campaign Negative Location Criterion, and Campaign Radius Criterion records in the download data. */
        ...
        /** Include Asset Group Negative Keyword records in the download data. */
        const AssetGroupNegativeKeywords = 'AssetGroupNegativeKeywords';

        /** Include Company List records in the account download data. */
        const CompanyList = 'CompanyList';

        /** Include Company Item records in the account download data. */
        const CompanyItem = 'CompanyItem';

        /** Reserved. */
        const AdGroupUrlTargets = 'AdGroupUrlTargets';

        /** Reserved. */
        const AdGroupAIPromptAssociations = 'AdGroupAIPromptAssociations';
    }
