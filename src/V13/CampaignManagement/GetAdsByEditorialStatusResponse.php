...

{
     ...
     * @link https://docs.microsoft.com/en-us/advertising/campaign-management-service/getadsbyeditorialstatus?view=bingads-13 GetAdsByEditorialStatus Response Object
     * 
     * @uses Ad
