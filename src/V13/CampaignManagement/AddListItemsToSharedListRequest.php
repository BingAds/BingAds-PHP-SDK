...

{
     ...
     * @link https://docs.microsoft.com/en-us/bingads/campaign-management-service/addlistitemstosharedlist?view=bingads-13 AddListItemsToSharedList Request Object
     * 
     * @uses SharedListItem
     * @uses SharedList
