...

{
     ...
     * @link https://docs.microsoft.com/en-us/bingads/campaign-management-service/getcampaignidsbybudgetids?view=bingads-13 GetCampaignIdsByBudgetIds Response Object
     * 
     * @uses IdCollection
     * @uses BatchError
