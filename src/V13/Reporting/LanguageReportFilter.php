...

{
     ...
     * @link https://docs.microsoft.com/en-us/bingads/reporting-service/languagereportfilter?view=bingads-13 LanguageReportFilter Value Set
     * 
     ...
     */
    final class LanguageReportFilter
    {
