...

{
     ...
     * @link https://docs.microsoft.com/en-us/advertising/reporting-service/reporttimezone?view=bingads-12 ReportTimeZone Value Set
     * 
     * @used-by BudgetSummaryReportTime
     * @used-by ReportTime
     */
    final class ReportTimeZone
    {
        ...
        /** The corresponding report time zone. */
        const IslandamabadKarachiTashkent = 'IslandamabadKarachiTashkent';
        ...
        /** The corresponding report time zone. */
        const AthensIslandanbulMinsk = 'AthensIslandanbulMinsk';
