...

{
     ...
     * @link https://docs.microsoft.com/en-us/bingads/campaign-management-service/getconversiongoalsbyids?view=bingads-12 GetConversionGoalsByIds Response Object
     * 
     * @uses ConversionGoal
     * @uses BatchError
