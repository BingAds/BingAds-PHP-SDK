...

{
     ...
     * @link https://docs.microsoft.com/en-us/advertising/campaign-management-service/addlistitemstosharedlist?view=bingads-12 AddListItemsToSharedList Request Object
     * 
     * @uses SharedListItem
     * @uses SharedList
