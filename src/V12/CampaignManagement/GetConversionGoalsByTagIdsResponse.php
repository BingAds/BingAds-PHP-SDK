...

{
     ...
     * @link https://docs.microsoft.com/en-us/bingads/campaign-management-service/getconversiongoalsbytagids?view=bingads-12 GetConversionGoalsByTagIds Response Object
     * 
     * @uses ConversionGoal
     * @uses BatchError
