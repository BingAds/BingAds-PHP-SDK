...

{
     ...
     * @link https://docs.microsoft.com/en-us/advertising/campaign-management-service/getmediametadatabyids?view=bingads-12 GetMediaMetaDataByIds Response Object
     * 
     * @uses MediaMetaData
     * @uses BatchError
