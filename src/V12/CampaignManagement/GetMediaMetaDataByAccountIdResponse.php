...

{
     ...
     * @link https://docs.microsoft.com/en-us/bingads/campaign-management-service/getmediametadatabyaccountid?view=bingads-12 GetMediaMetaDataByAccountId Response Object
     * 
     * @uses MediaMetaData
