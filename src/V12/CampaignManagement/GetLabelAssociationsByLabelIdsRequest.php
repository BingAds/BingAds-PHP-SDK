...

{
     ...
     * @link https://docs.microsoft.com/en-us/bingads/campaign-management-service/getlabelassociationsbylabelids?view=bingads-12 GetLabelAssociationsByLabelIds Request Object
     * 
     * @uses EntityType
     * @uses Paging
