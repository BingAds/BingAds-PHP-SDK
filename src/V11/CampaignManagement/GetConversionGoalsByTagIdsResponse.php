...

{
     ...
     * @link https://docs.microsoft.com/en-us/bingads/campaign-management-service/getconversiongoalsbytagids?view=bingads-11 GetConversionGoalsByTagIds Response Object
     * 
     * @uses ConversionGoal
     * @uses BatchError
