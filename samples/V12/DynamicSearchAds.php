...
use Microsoft\BingAds\V12\CampaignManagement\NegativeCampaignCriterion;
...
use Microsoft\BingAds\V12\CampaignManagement\DynamicSearchAd;
use Microsoft\BingAds\V12\CampaignManagement\DynamicSearchAdsSetting;
use Microsoft\BingAds\V12\CampaignManagement\WebpageConditionOperand;
use Microsoft\BingAds\V12\CampaignManagement\WebpageCondition;
use Microsoft\BingAds\V12\CampaignManagement\WebpageParameter;
use Microsoft\BingAds\V12\CampaignManagement\Webpage;
...
try
{
    ...
    $adGroupWebpagePositivePageContentErrors = $addAdGroupCriterionsResponse->NestedPartialErrors;
    ...
    foreach ($adGroupCriterions->AdGroupCriterion as $adGroupCriterion)
    {
        if ($adGroupCriterion->Type === "BiddableAdGroupCriterion")
        {
            ...
            $biddableAdGroupCriterionUpdateAttemptSuccess->Criterion = new SoapVar(
                $criterionUpdateAttemptSuccess, 
                SOAP_ENC_OBJECT, 
                'Webpage', 
                $GLOBALS['CampaignManagementProxy']->GetNamespace());
            $biddableAdGroupCriterionUpdateAttemptSuccess->CriterionBid = new SoapVar(
                $criterionBidUpdateAttemptSuccess, 
                SOAP_ENC_OBJECT, 
                'FixedBid', 
                $GLOBALS['CampaignManagementProxy']->GetNamespace());

            $updateAdGroupCriterions[] = new SoapVar(
                $biddableAdGroupCriterionUpdateAttemptSuccess, 
                SOAP_ENC_OBJECT, 
                'BiddableAdGroupCriterion', 
                $GLOBALS['CampaignManagementProxy']->GetNamespace());
        }
        else if ($adGroupCriterion->Type === "NegativeAdGroupCriterion")
        {
            ...
            $negativeAdGroupCriterionUpdateAttemptFailure->Criterion = new SoapVar(
                $criterionUpdateAttemptFailure, 
                SOAP_ENC_OBJECT, 
                'Webpage', 
                $GLOBALS['CampaignManagementProxy']->GetNamespace());
            
            $updateAdGroupCriterions[] = new SoapVar(
                $negativeAdGroupCriterionUpdateAttemptFailure, 
                SOAP_ENC_OBJECT, 
