...
use Microsoft\BingAds\V11\CampaignManagement\AddAudiencesRequest;
...
use Microsoft\BingAds\V11\CampaignManagement\AddLabelsRequest;
use Microsoft\BingAds\V11\CampaignManagement\AddListItemsToSharedListRequest;
use Microsoft\BingAds\V11\CampaignManagement\AddMediaRequest;
...
use Microsoft\BingAds\V11\CampaignManagement\AppealEditorialRejectionsRequest;
use Microsoft\BingAds\V11\CampaignManagement\ApplyOfflineConversionsRequest;
...
use Microsoft\BingAds\V11\CampaignManagement\DeleteAdGroupsRequest;
use Microsoft\BingAds\V11\CampaignManagement\DeleteAdsRequest;
use Microsoft\BingAds\V11\CampaignManagement\DeleteAudiencesRequest;
use Microsoft\BingAds\V11\CampaignManagement\DeleteBudgetsRequest;
use Microsoft\BingAds\V11\CampaignManagement\DeleteCampaignCriterionsRequest;
...
use Microsoft\BingAds\V11\CampaignManagement\DeleteLabelAssociationsRequest;
use Microsoft\BingAds\V11\CampaignManagement\DeleteLabelsRequest;
use Microsoft\BingAds\V11\CampaignManagement\DeleteListItemsFromSharedListRequest;
use Microsoft\BingAds\V11\CampaignManagement\DeleteMediaRequest;
...
use Microsoft\BingAds\V11\CampaignManagement\GetAccountPropertiesRequest;
use Microsoft\BingAds\V11\CampaignManagement\GetAdExtensionIdsByAccountIdRequest;
use Microsoft\BingAds\V11\CampaignManagement\GetAdExtensionsAssociationsRequest;
...
use Microsoft\BingAds\V11\CampaignManagement\GetAdsByEditorialStatusRequest;
use Microsoft\BingAds\V11\CampaignManagement\GetAdsByIdsRequest;
...
use Microsoft\BingAds\V11\CampaignManagement\GetBSCCountriesRequest;
...
use Microsoft\BingAds\V11\CampaignManagement\GetConversionGoalsByTagIdsRequest;
use Microsoft\BingAds\V11\CampaignManagement\GetEditorialReasonsByIdsRequest;
...
use Microsoft\BingAds\V11\CampaignManagement\GetKeywordsByEditorialStatusRequest;
use Microsoft\BingAds\V11\CampaignManagement\GetKeywordsByIdsRequest;
use Microsoft\BingAds\V11\CampaignManagement\GetLabelAssociationsByEntityIdsRequest;
use Microsoft\BingAds\V11\CampaignManagement\GetLabelAssociationsByLabelIdsRequest;
use Microsoft\BingAds\V11\CampaignManagement\GetLabelsByIdsRequest;
use Microsoft\BingAds\V11\CampaignManagement\GetListItemsBySharedListRequest;
use Microsoft\BingAds\V11\CampaignManagement\GetMediaAssociationsRequest;
use Microsoft\BingAds\V11\CampaignManagement\GetMediaByIdsRequest;
use Microsoft\BingAds\V11\CampaignManagement\GetMediaMetaDataByAccountIdRequest;
use Microsoft\BingAds\V11\CampaignManagement\GetMediaMetaDataByIdsRequest;
use Microsoft\BingAds\V11\CampaignManagement\GetNegativeKeywordsByEntityIdsRequest;
use Microsoft\BingAds\V11\CampaignManagement\GetNegativeSitesByAdGroupIdsRequest;
use Microsoft\BingAds\V11\CampaignManagement\GetNegativeSitesByCampaignIdsRequest;
use Microsoft\BingAds\V11\CampaignManagement\GetProfileDataFileUrlRequest;
...
use Microsoft\BingAds\V11\CampaignManagement\SetAccountPropertiesRequest;
use Microsoft\BingAds\V11\CampaignManagement\SetAdExtensionsAssociationsRequest;
use Microsoft\BingAds\V11\CampaignManagement\SetLabelAssociationsRequest;
use Microsoft\BingAds\V11\CampaignManagement\SetNegativeSitesToAdGroupsRequest;
use Microsoft\BingAds\V11\CampaignManagement\SetNegativeSitesToCampaignsRequest;
...
use Microsoft\BingAds\V11\CampaignManagement\UpdateAudiencesRequest;
use Microsoft\BingAds\V11\CampaignManagement\UpdateBudgetsRequest;
use Microsoft\BingAds\V11\CampaignManagement\UpdateCampaignCriterionsRequest;
...
use Microsoft\BingAds\V11\CampaignManagement\UpdateLabelsRequest;
...
final class CampaignManagementExampleHelper {
    ...
    static function OutputAccountMigrationStatusesInfo($dataObject)
    {
        ...
        if (!empty($dataObject))
        {
            ...
            self::OutputArrayOfMigrationStatusInfo($dataObject->MigrationStatusInfo);
        }
    ...
    static function OutputAdExtension($dataObject)
    {
        ...
        if (!empty($dataObject))
        {
            ...
            if($dataObject->Type === "Sitelink2AdExtension")
            {
                self::OutputSitelink2AdExtension($dataObject);
            }
            if($dataObject->Type === "SiteLinksAdExtension")
            {
                self::OutputSiteLinksAdExtension($dataObject);
            }
    ...
    static function OutputAdGroup($dataObject)
    {
        ...
        if (!empty($dataObject))
        {
            ...
            self::OutputBid($dataObject->ContentMatchBid);
            ...
            self::OutputStatusMessage(sprintf("PricingModel: %s", $dataObject->PricingModel));
            self::OutputStatusMessage(sprintf("PrivacyStatus: %s", $dataObject->PrivacyStatus));
            self::OutputStatusMessage(sprintf("RemarketingTargetingSetting: %s", $dataObject->RemarketingTargetingSetting));
            self::OutputBid($dataObject->SearchBid);
    ...
    static function OutputLocationAdExtension($dataObject)
    {
        ...
        if (!empty($dataObject))
        {
            ...
            self::OutputStatusMessage(sprintf("IconMediaId: %s", $dataObject->IconMediaId));
            self::OutputStatusMessage(sprintf("ImageMediaId: %s", $dataObject->ImageMediaId));
            self::OutputStatusMessage(sprintf("PhoneNumber: %s", $dataObject->PhoneNumber));
        }
    ...
    static function OutputSiteLink($dataObject)
    {
        self::OutputStatusMessage("* * * Begin OutputSiteLink * * *");
        if (!empty($dataObject))
        {
        ...
        self::OutputStatusMessage("* * * End OutputSiteLink * * *");
    }
    static function OutputArrayOfSiteLink($dataObjects)
    {
        if(count((array)$dataObjects) == 0 || !isset($dataObjects->SiteLink))
        {
            return;
        }
        self::OutputStatusMessage("* * * Begin OutputArrayOfSiteLink * * *");
        foreach ($dataObjects->SiteLink as $dataObject)
        {
            self::OutputSiteLink($dataObject);
        }
        self::OutputStatusMessage("* * * End OutputArrayOfSiteLink * * *");
    }
    static function OutputSitelink2AdExtension($dataObject)
    {
        self::OutputStatusMessage("* * * Begin OutputSitelink2AdExtension * * *");
        if (!empty($dataObject))
        {
            self::OutputStatusMessage(sprintf("Description1: %s", $dataObject->Description1));
            self::OutputStatusMessage(sprintf("Description2: %s", $dataObject->Description2));
        ...
        self::OutputStatusMessage("* * * End OutputSitelink2AdExtension * * *");
    }
    static function OutputArrayOfSitelink2AdExtension($dataObjects)
    {
        if(count((array)$dataObjects) == 0 || !isset($dataObjects->Sitelink2AdExtension))
        {
            return;
        }
        self::OutputStatusMessage("* * * Begin OutputArrayOfSitelink2AdExtension * * *");
        foreach ($dataObjects->Sitelink2AdExtension as $dataObject)
        {
            self::OutputSitelink2AdExtension($dataObject);
        }
        self::OutputStatusMessage("* * * End OutputArrayOfSitelink2AdExtension * * *");
    }
    static function OutputSiteLinksAdExtension($dataObject)
    {
        self::OutputStatusMessage("* * * Begin OutputSiteLinksAdExtension * * *");
        if (!empty($dataObject))
        {
            self::OutputArrayOfSiteLink($dataObject->SiteLinks);
        }
        self::OutputStatusMessage("* * * End OutputSiteLinksAdExtension * * *");
    }
    static function OutputArrayOfSiteLinksAdExtension($dataObjects)
    {
        if(count((array)$dataObjects) == 0 || !isset($dataObjects->SiteLinksAdExtension))
        {
            return;
        }
        self::OutputStatusMessage("* * * Begin OutputArrayOfSiteLinksAdExtension * * *");
        foreach ($dataObjects->SiteLinksAdExtension as $dataObject)
        {
            self::OutputSiteLinksAdExtension($dataObject);
        }
        self::OutputStatusMessage("* * * End OutputArrayOfSiteLinksAdExtension * * *");
    }
    ...
    static function OutputAdDistribution($valueSet)
    {
        self::OutputStatusMessage("* * * Begin OutputAdDistribution * * *");
        self::OutputStatusMessage(sprintf("Values in %s", $valueSet->type));
        foreach ($valueSet->string as $value)
        {
            self::OutputStatusMessage($value);
        }
        self::OutputStatusMessage("* * * End OutputAdDistribution * * *");
    }
    static function OutputArrayOfAdDistribution($valueSets)
    {
        if(count((array)$valueSets) == 0)
        {
            return;
        }
        self::OutputStatusMessage("* * * Begin OutputArrayOfAdDistribution * * *");
        foreach ($valueSets->AdDistribution as $valueSet)
        {
            self::OutputAdDistribution($valueSet);
        }
        self::OutputStatusMessage("* * * End OutputArrayOfAdDistribution * * *");
    }
    ...
    static function OutputPricingModel($valueSet)
    {
        self::OutputStatusMessage("* * * Begin OutputPricingModel * * *");
        self::OutputStatusMessage(sprintf("Values in %s", $valueSet->type));
        foreach ($valueSet->string as $value)
        {
            self::OutputStatusMessage($value);
        }
        self::OutputStatusMessage("* * * End OutputPricingModel * * *");
    }
    static function OutputArrayOfPricingModel($valueSets)
    {
        if(count((array)$valueSets) == 0)
        {
            return;
        }
        self::OutputStatusMessage("* * * Begin OutputArrayOfPricingModel * * *");
        foreach ($valueSets->PricingModel as $valueSet)
        {
            self::OutputPricingModel($valueSet);
        }
        self::OutputStatusMessage("* * * End OutputArrayOfPricingModel * * *");
    }
    ...
    static function OutputRemarketingTargetingSetting($valueSet)
    {
        self::OutputStatusMessage("* * * Begin OutputRemarketingTargetingSetting * * *");
        self::OutputStatusMessage(sprintf("Values in %s", $valueSet->type));
        foreach ($valueSet->string as $value)
        {
            self::OutputStatusMessage($value);
        }
        self::OutputStatusMessage("* * * End OutputRemarketingTargetingSetting * * *");
    }
    static function OutputArrayOfRemarketingTargetingSetting($valueSets)
    {
        if(count((array)$valueSets) == 0)
        {
            return;
        }
        self::OutputStatusMessage("* * * Begin OutputArrayOfRemarketingTargetingSetting * * *");
        foreach ($valueSets->RemarketingTargetingSetting as $valueSet)
        {
            self::OutputRemarketingTargetingSetting($valueSet);
        }
        self::OutputStatusMessage("* * * End OutputArrayOfRemarketingTargetingSetting * * *");
    }
    ...
    static function OutputKeywordAdditionalField($valueSet)
    {
        self::OutputStatusMessage("* * * Begin OutputKeywordAdditionalField * * *");
        self::OutputStatusMessage(sprintf("Values in %s", $valueSet->type));
        foreach ($valueSet->string as $value)
        {
            self::OutputStatusMessage($value);
        }
        self::OutputStatusMessage("* * * End OutputKeywordAdditionalField * * *");
    }
    static function OutputArrayOfKeywordAdditionalField($valueSets)
    {
        if(count((array)$valueSets) == 0)
        {
            return;
        }
        self::OutputStatusMessage("* * * Begin OutputArrayOfKeywordAdditionalField * * *");
        foreach ($valueSets->KeywordAdditionalField as $valueSet)
        {
            self::OutputKeywordAdditionalField($valueSet);
        }
        self::OutputStatusMessage("* * * End OutputArrayOfKeywordAdditionalField * * *");
    }
