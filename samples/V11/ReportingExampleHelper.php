...
final class ReportingExampleHelper {
    ...
    static function OutputNonHourlyReportAggregation($valueSet)
    {
        self::OutputStatusMessage("* * * Begin OutputNonHourlyReportAggregation * * *");
        self::OutputStatusMessage(sprintf("Values in %s", $valueSet->type));
        foreach ($valueSet->string as $value)
        {
            self::OutputStatusMessage($value);
        }
        self::OutputStatusMessage("* * * End OutputNonHourlyReportAggregation * * *");
    }
    static function OutputArrayOfNonHourlyReportAggregation($valueSets)
    {
        if(count((array)$valueSets) == 0)
        {
            return;
        }
        self::OutputStatusMessage("* * * Begin OutputArrayOfNonHourlyReportAggregation * * *");
        foreach ($valueSets->NonHourlyReportAggregation as $valueSet)
        {
            self::OutputNonHourlyReportAggregation($valueSet);
        }
        self::OutputStatusMessage("* * * End OutputArrayOfNonHourlyReportAggregation * * *");
    }
    ...
    static function OutputBudgetSummaryReportTimePeriod($valueSet)
    {
        self::OutputStatusMessage("* * * Begin OutputBudgetSummaryReportTimePeriod * * *");
        self::OutputStatusMessage(sprintf("Values in %s", $valueSet->type));
        foreach ($valueSet->string as $value)
        {
            self::OutputStatusMessage($value);
        }
        self::OutputStatusMessage("* * * End OutputBudgetSummaryReportTimePeriod * * *");
    }
    static function OutputArrayOfBudgetSummaryReportTimePeriod($valueSets)
    {
        if(count((array)$valueSets) == 0)
        {
            return;
        }
        self::OutputStatusMessage("* * * Begin OutputArrayOfBudgetSummaryReportTimePeriod * * *");
        foreach ($valueSets->BudgetSummaryReportTimePeriod as $valueSet)
        {
            self::OutputBudgetSummaryReportTimePeriod($valueSet);
        }
        self::OutputStatusMessage("* * * End OutputArrayOfBudgetSummaryReportTimePeriod * * *");
    }
    ...
    static function OutputSearchQueryReportAggregation($valueSet)
    {
        self::OutputStatusMessage("* * * Begin OutputSearchQueryReportAggregation * * *");
        self::OutputStatusMessage(sprintf("Values in %s", $valueSet->type));
        foreach ($valueSet->string as $value)
        {
            self::OutputStatusMessage($value);
        }
        self::OutputStatusMessage("* * * End OutputSearchQueryReportAggregation * * *");
    }
    static function OutputArrayOfSearchQueryReportAggregation($valueSets)
    {
        if(count((array)$valueSets) == 0)
        {
            return;
        }
        self::OutputStatusMessage("* * * Begin OutputArrayOfSearchQueryReportAggregation * * *");
        foreach ($valueSets->SearchQueryReportAggregation as $valueSet)
        {
            self::OutputSearchQueryReportAggregation($valueSet);
        }
        self::OutputStatusMessage("* * * End OutputArrayOfSearchQueryReportAggregation * * *");
    }
