...
// Specify the Microsoft\BingAds\V11\CustomerBilling classes that will be used.
use Microsoft\BingAds\V11\CustomerBilling\AddInsertionOrderRequest;
use Microsoft\BingAds\V11\CustomerBilling\GetAccountMonthlySpendRequest;
use Microsoft\BingAds\V11\CustomerBilling\GetBillingDocumentsRequest;
use Microsoft\BingAds\V11\CustomerBilling\GetBillingDocumentsInfoRequest;
use Microsoft\BingAds\V11\CustomerBilling\GetInsertionOrdersByAccountRequest;
use Microsoft\BingAds\V11\CustomerBilling\SearchInsertionOrdersRequest;
use Microsoft\BingAds\V11\CustomerBilling\UpdateInsertionOrderRequest;
...
final class CustomerBillingExampleHelper {
    ...
    static function OutputInsertionOrder($dataObject)
    {
        ...
        if (!empty($dataObject))
        {
            ...
            self::OutputStatusMessage(sprintf("InsertionOrderId: %s", $dataObject->InsertionOrderId));
            ...
            self::OutputStatusMessage(sprintf("ChangePendingReview: %s", $dataObject->ChangePendingReview));
        }
